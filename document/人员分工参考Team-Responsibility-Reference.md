...
gantt
    ...
    section 硬核开发组
    任务确认与数据字段设计           :dev1, 2026-06-06, 1d
    公开数据集筛选与清洗             :dev2, 2026-06-07, 1d
    文本和图像基线模型               :dev3, 2026-06-08, 2d
    多模态融合第一版                 :dev4, 2026-06-09, 1d
    消融实验与错误分析               :dev5, 2026-06-10, 1d
    代码冻结与交接包                 :milestone, dev6, 2026-06-11, 1d

    section 报告答辩组
    报告目录与评分清单               :doc1, 2026-06-06, 1d
    绪论与相关技术草稿               :doc2, 2026-06-07, 3d
    系统架构与数据章节               :doc3, 2026-06-10, 2d
    实验分析与报告终稿               :doc4, 2026-06-13, 2d
    PPT与讲稿                        :doc5, 2026-06-13, 3d
    模拟答辩与最终提交               :doc6, 2026-06-15, 2d
```
